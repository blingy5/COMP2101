...
[ $firstNumber %2 -eq 0 ] $$ echo "The number is even" || echo "The number is odd"
[ $secondNumber %2 -eq 0 ] $$ echo "The number is even" || echo "The number is odd"
...
[ -z USER ] && echo "not empty"
[ -n USER ] && echo "is empty"
