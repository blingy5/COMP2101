...
#   To separate it and make it easier to read, we should take those commands and put them before the output generation, 
#   in their own section that generates the data and saves it in variables
